              ...
              <div style="display: flex; height: 50px" class="mt-3 mb-3">
                ...
                <div>
                  <v-text-field
                    ...
                    solo
                    readonly
                    :value="carBookBoard.viewCount"
                  />
                </div>
                <div
                  class="mt-2"
                  v-if="
                    (carBookBoard.writer == this.nickName &&
...
export default {
  ...
  methods: {
    ...
    onDelete() {
      ...
      axios
        .delete(`http://localhost:7777/noticeBoard/${id}`)
        .then(() => {
          alert("삭제 성공!");
