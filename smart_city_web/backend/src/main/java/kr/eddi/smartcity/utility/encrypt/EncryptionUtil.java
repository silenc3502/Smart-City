package kr.eddi.smartcity.utility.encrypt;

import kr.eddi.smartcity.utility.encrypt.exception.UnableToGenerateHash;
...
public class EncryptionUtil {
    ...
    /**
     * @param plainToCheck 체크할 평문
     * @param originHash   원본 해시
     * @return 올바르면 true
     * @throws UnableToGenerateHash 해시 생성 불가
     */
