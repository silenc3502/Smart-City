...
int32_t spi_open(const spi_dev_num spi_num, const sensor_dev_name dev_name)
{
    if(spi_dev_t[spi_num].spi_reg == spi_reg[spi_num])
        return REG_ALLOC_ERR;
