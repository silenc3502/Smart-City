...
(* CORE_GENERATION_INFO="system_v_demosaic_0_1_v_demosaic,hls_ip_2021_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=6.667000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.807500,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=31,HLS_SYN_DSP=0,HLS_SYN_FF=7855,HLS_SYN_LUT=11475,HLS_VERSION=2021_1}" *)

module system_v_demosaic_0_1_v_demosaic (
...
system_v_demosaic_0_1_CTRL_s_axi #(
...
system_v_demosaic_0_1_Block_split1_proc Block_split1_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
system_v_demosaic_0_1_AXIvideo2MultiBayer AXIvideo2MultiBayer_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
system_v_demosaic_0_1_Debayer Debayer_U0(
...
system_v_demosaic_0_1_ZipperRemoval ZipperRemoval_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
system_v_demosaic_0_1_MultiPixStream2AXIvideo MultiPixStream2AXIvideo_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
system_v_demosaic_0_1_fifo_w16_d2_S_x bayer_phase_assign_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_1_fifo_w16_d2_S_x imgBayer_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_1_fifo_w48_d2_S_x imgRgb_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_1_fifo_w48_d2_S_x imgUnzip_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_1_start_for_ZipperRemoval_U0 start_for_ZipperRemoval_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
system_v_demosaic_0_1_start_for_MultiPixStream2AXIvideo_U0 start_for_MultiPixStream2AXIvideo_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
// synthesis translate_off
`include "system_v_demosaic_0_1_hls_deadlock_detector.vh"
`include "system_v_demosaic_0_1_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //system_v_demosaic_0_1_v_demosaic
