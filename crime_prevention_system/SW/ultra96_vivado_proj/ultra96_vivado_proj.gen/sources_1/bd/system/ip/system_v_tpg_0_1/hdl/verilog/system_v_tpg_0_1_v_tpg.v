...
(* CORE_GENERATION_INFO="system_v_tpg_0_1_v_tpg,hls_ip_2021_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=6.667000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.588000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=5,HLS_SYN_DSP=0,HLS_SYN_FF=5886,HLS_SYN_LUT=8033,HLS_VERSION=2021_1}" *)

module system_v_tpg_0_1_v_tpg (
...
reg   [31:0] count;
reg   [31:0] s;
wire   [0:0] icmp_ln456_fu_563_p2;
reg   [0:0] icmp_ln456_reg_631;
wire    ap_CS_fsm_state2;
wire   [31:0] add_ln458_fu_573_p2;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_343_fid_in;
wire   [31:0] grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TDATA;
wire   [3:0] grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TKEEP;
wire   [3:0] grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TSTRB;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TUSER;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TLAST;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TID;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TDEST;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_343_fid;
wire    grp_v_tpgHlsDataFlow_fu_343_ap_start;
wire    grp_v_tpgHlsDataFlow_fu_343_s_axis_video_TREADY;
wire    grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TVALID;
wire    grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TREADY;
wire    grp_v_tpgHlsDataFlow_fu_343_fid_ap_vld;
wire    grp_v_tpgHlsDataFlow_fu_343_ap_done;
wire    grp_v_tpgHlsDataFlow_fu_343_ap_ready;
wire    grp_v_tpgHlsDataFlow_fu_343_ap_idle;
reg    grp_v_tpgHlsDataFlow_fu_343_ap_continue;
wire   [15:0] grp_reg_unsigned_short_s_fu_557_ap_return;
reg   [31:0] count_new_0_reg_332;
wire   [0:0] icmp_ln459_fu_579_p2;
reg    grp_v_tpgHlsDataFlow_fu_343_ap_start_reg;
wire    ap_CS_fsm_state3;
wire    ap_CS_fsm_state4;
wire    ap_sync_grp_v_tpgHlsDataFlow_fu_343_ap_ready;
wire    ap_sync_grp_v_tpgHlsDataFlow_fu_343_ap_done;
reg    ap_block_state4_on_subcall_done;
reg    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_343_ap_ready;
reg    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_343_ap_done;
wire   [31:0] select_ln461_fu_611_p3;
wire   [28:0] tmp_1_fu_589_p4;
wire   [0:0] icmp_ln461_fu_599_p2;
wire   [31:0] add_ln463_fu_605_p2;
...
#0 count = 32'd0;
#0 s = 32'd0;
#0 grp_v_tpgHlsDataFlow_fu_343_ap_start_reg = 1'b0;
#0 ap_sync_reg_grp_v_tpgHlsDataFlow_fu_343_ap_ready = 1'b0;
#0 ap_sync_reg_grp_v_tpgHlsDataFlow_fu_343_ap_done = 1'b0;
end

system_v_tpg_0_1_v_tpgHlsDataFlow grp_v_tpgHlsDataFlow_fu_343(
    ...
    .width(width),
    .field_id(field_id),
    .fid_in(grp_v_tpgHlsDataFlow_fu_343_fid_in),
    ...
    .dpYUVCoef(dpYUVCoef),
    .m_axis_video_TDATA(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TDATA),
    .m_axis_video_TKEEP(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TKEEP),
    .m_axis_video_TSTRB(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TSTRB),
    .m_axis_video_TUSER(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TUSER),
    .m_axis_video_TLAST(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TLAST),
    .m_axis_video_TID(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TID),
    .m_axis_video_TDEST(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TDEST),
    .fid(grp_v_tpgHlsDataFlow_fu_343_fid),
    .s(s),
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    ...
    .ap_start(grp_v_tpgHlsDataFlow_fu_343_ap_start),
    .s_axis_video_TVALID(s_axis_video_TVALID_int_regslice),
    .s_axis_video_TREADY(grp_v_tpgHlsDataFlow_fu_343_s_axis_video_TREADY),
    .enableInput_ap_vld(1'b1),
    .height_ap_vld(1'b1),
    .width_ap_vld(1'b1),
    .colorFormat_ap_vld(1'b1),
    .s_ap_vld(1'b1),
    .m_axis_video_TVALID(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TVALID),
    .m_axis_video_TREADY(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TREADY),
    .fid_in_ap_vld(1'b1),
    .fid_ap_vld(grp_v_tpgHlsDataFlow_fu_343_fid_ap_vld),
    .field_id_ap_vld(1'b1),
    .ap_done(grp_v_tpgHlsDataFlow_fu_343_ap_done),
    .ap_ready(grp_v_tpgHlsDataFlow_fu_343_ap_ready),
    .ap_idle(grp_v_tpgHlsDataFlow_fu_343_ap_idle),
    .ap_continue(grp_v_tpgHlsDataFlow_fu_343_ap_continue)
);

system_v_tpg_0_1_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_557(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .d(bck_motion_en),
    .ap_return(grp_reg_unsigned_short_s_fu_557_ap_return)
);

system_v_tpg_0_1_CTRL_s_axi #(
...
system_v_tpg_0_1_regslice_both #(
    .DataWidth( 32 ))
...
regslice_both_m_axis_video_V_data_V_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .data_in(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TDATA),
    .vld_in(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TVALID),
...
regslice_both_m_axis_video_V_keep_V_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .data_in(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TKEEP),
    .vld_in(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TVALID),
...
regslice_both_m_axis_video_V_strb_V_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .data_in(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TSTRB),
    .vld_in(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TVALID),
...
regslice_both_m_axis_video_V_user_V_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .data_in(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TUSER),
    .vld_in(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TVALID),
...
regslice_both_m_axis_video_V_last_V_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .data_in(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TLAST),
    .vld_in(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TVALID),
...
regslice_both_m_axis_video_V_id_V_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .data_in(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TID),
    .vld_in(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TVALID),
...
regslice_both_m_axis_video_V_dest_V_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .data_in(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TDEST),
    .vld_in(grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TVALID),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_v_tpgHlsDataFlow_fu_343_ap_done <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_343_ap_done <= 1'b0;
        end else if ((grp_v_tpgHlsDataFlow_fu_343_ap_done == 1'b1)) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_343_ap_done <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_v_tpgHlsDataFlow_fu_343_ap_ready <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_343_ap_ready <= 1'b0;
        end else if ((grp_v_tpgHlsDataFlow_fu_343_ap_ready == 1'b1)) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_343_ap_ready <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_v_tpgHlsDataFlow_fu_343_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state3) | ((ap_sync_grp_v_tpgHlsDataFlow_fu_343_ap_ready == 1'b0) & (1'b1 == ap_CS_fsm_state4)))) begin
            grp_v_tpgHlsDataFlow_fu_343_ap_start_reg <= 1'b1;
        end else if ((grp_v_tpgHlsDataFlow_fu_343_ap_ready == 1'b1)) begin
            grp_v_tpgHlsDataFlow_fu_343_ap_start_reg <= 1'b0;
        end
    end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln456_fu_563_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        if ((icmp_ln459_fu_579_p2 == 1'd0)) begin
            count_new_0_reg_332 <= add_ln458_fu_573_p2;
        end else if ((icmp_ln459_fu_579_p2 == 1'd1)) begin
            count_new_0_reg_332 <= 32'd0;
        end
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln456_reg_631 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        count <= count_new_0_reg_332;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        icmp_ln456_reg_631 <= icmp_ln456_fu_563_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln456_fu_563_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln459_fu_579_p2 == 1'd1))) begin
        s <= select_ln461_fu_611_p3;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
        grp_v_tpgHlsDataFlow_fu_343_ap_continue = 1'b1;
    end else begin
        grp_v_tpgHlsDataFlow_fu_343_ap_continue = 1'b0;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        s_axis_video_TREADY_int_regslice = grp_v_tpgHlsDataFlow_fu_343_s_axis_video_TREADY;
    end else begin
...
assign add_ln458_fu_573_p2 = (count + 32'd1);

assign add_ln463_fu_605_p2 = (s + 32'd1);
...
always @ (*) begin
    ap_block_state4_on_subcall_done = ((ap_sync_grp_v_tpgHlsDataFlow_fu_343_ap_ready & ap_sync_grp_v_tpgHlsDataFlow_fu_343_ap_done) == 1'b0);
end
...
assign ap_sync_grp_v_tpgHlsDataFlow_fu_343_ap_done = (grp_v_tpgHlsDataFlow_fu_343_ap_done | ap_sync_reg_grp_v_tpgHlsDataFlow_fu_343_ap_done);

assign ap_sync_grp_v_tpgHlsDataFlow_fu_343_ap_ready = (grp_v_tpgHlsDataFlow_fu_343_ap_ready | ap_sync_reg_grp_v_tpgHlsDataFlow_fu_343_ap_ready);

assign fid = grp_v_tpgHlsDataFlow_fu_343_fid;

assign grp_v_tpgHlsDataFlow_fu_343_ap_start = grp_v_tpgHlsDataFlow_fu_343_ap_start_reg;

assign grp_v_tpgHlsDataFlow_fu_343_fid_in = fid_in;

assign grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TREADY = (m_axis_video_TREADY_int_regslice & ap_CS_fsm_state4);

assign icmp_ln456_fu_563_p2 = ((grp_reg_unsigned_short_s_fu_557_ap_return == 16'd1) ? 1'b1 : 1'b0);

assign icmp_ln459_fu_579_p2 = ((add_ln458_fu_573_p2 == 32'd10) ? 1'b1 : 1'b0);

assign icmp_ln461_fu_599_p2 = (($signed(tmp_1_fu_589_p4) < $signed(29'd1)) ? 1'b1 : 1'b0);

assign m_axis_video_TVALID = regslice_both_m_axis_video_V_data_V_U_vld_out;

assign m_axis_video_TVALID_int_regslice = grp_v_tpgHlsDataFlow_fu_343_m_axis_video_TVALID;

assign s_axis_video_TREADY = regslice_both_s_axis_video_V_data_V_U_ack_in;

assign select_ln461_fu_611_p3 = ((icmp_ln461_fu_599_p2[0:0] == 1'b1) ? add_ln463_fu_605_p2 : 32'd0);

assign tmp_1_fu_589_p4 = {{s[31:3]}};


// synthesis translate_off
`include "system_v_tpg_0_1_hls_deadlock_detector.vh"
`include "system_v_tpg_0_1_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //system_v_tpg_0_1_v_tpg
