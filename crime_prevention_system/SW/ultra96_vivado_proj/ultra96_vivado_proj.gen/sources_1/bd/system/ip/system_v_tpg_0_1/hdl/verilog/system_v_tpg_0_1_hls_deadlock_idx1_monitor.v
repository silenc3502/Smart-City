...
module system_v_tpg_0_1_hls_deadlock_idx1_monitor ( // for module system_v_tpg_0_1_v_tpg_inst.grp_v_tpgHlsDataFlow_fu_343
    input wire clock,
    input wire reset,
...
// instant sub module
 system_v_tpg_0_1_hls_deadlock_idx2_monitor system_v_tpg_0_1_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
