#ifndef SMART_CITY_SOCKET_SERVER_PRE_ALLOCATED_SLAB_H
#define SMART_CITY_SOCKET_SERVER_PRE_ALLOCATED_SLAB_H
...
#endif //SMART_CITY_SOCKET_SERVER_PRE_ALLOCATED_SLAB_H